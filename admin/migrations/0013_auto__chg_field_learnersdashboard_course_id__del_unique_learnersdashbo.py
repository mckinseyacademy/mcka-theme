...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'LearnersDashboard', fields ['course_id']
        db.delete_unique(u'admin_learnersdashboard', ['course_id'])


        # Changing field 'LearnersDashboard.course_id'
        db.alter_column(u'admin_learnersdashboard', 'course_id', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'LearnersDashboard.course_id'
        db.alter_column(u'admin_learnersdashboard', 'course_id', self.gf('django.db.models.fields.IntegerField')(unique=True))
        # Adding unique constraint on 'LearnersDashboard', fields ['course_id']
        db.create_unique(u'admin_learnersdashboard', ['course_id'])
