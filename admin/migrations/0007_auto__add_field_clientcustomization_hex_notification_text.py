...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClientCustomization.hex_notification_text'
        db.add_column(u'admin_clientcustomization', 'hex_notification_text',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=7),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClientCustomization.hex_notification_text'
        db.delete_column(u'admin_clientcustomization', 'hex_notification_text')
