...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClientCustomization.client_logo'
        db.add_column(u'admin_clientcustomization', 'client_logo',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClientCustomization.client_logo'
        db.delete_column(u'admin_clientcustomization', 'client_logo')
