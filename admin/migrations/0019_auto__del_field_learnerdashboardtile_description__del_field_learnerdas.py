...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'LearnerDashboardTile.description'
        db.delete_column(u'admin_learnerdashboardtile', 'description')
        ...
        # Adding field 'LearnerDashboardTile.label'
        db.add_column(u'admin_learnerdashboardtile', 'label',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True),
                      keep_default=False)

        # Adding field 'LearnerDashboardTile.note'
        db.add_column(u'admin_learnerdashboardtile', 'note',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=40, blank=True),
                      keep_default=False)

        # Adding field 'LearnerDashboardTile.label_color'
        db.add_column(u'admin_learnerdashboardtile', 'label_color',
                      self.gf('django.db.models.fields.CharField')(default='#000000', max_length=20, blank=True),
                      keep_default=False)

        # Adding field 'LearnerDashboardTile.note_color'
        db.add_column(u'admin_learnerdashboardtile', 'note_color',
                      self.gf('django.db.models.fields.CharField')(default='#868685', max_length=20, blank=True),
                      keep_default=False)


        # Changing field 'LearnerDashboardTile.title'
        db.alter_column(u'admin_learnerdashboardtile', 'title', self.gf('django.db.models.fields.CharField')(max_length=40))
        # Deleting field 'BrandingSettings.navigation_colors'
        db.delete_column(u'admin_brandingsettings', 'navigation_colors')

        # Deleting field 'BrandingSettings.text_colors'
        db.delete_column(u'admin_brandingsettings', 'text_colors')
        ...
        # Adding field 'BrandingSettings.icon_color'
        db.add_column(u'admin_brandingsettings', 'icon_color',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True),
                      keep_default=False)

        # Adding field 'BrandingSettings.background_color'
        db.add_column(u'admin_brandingsettings', 'background_color',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'LearnerDashboardTile.description'
        db.add_column(u'admin_learnerdashboardtile', 'description',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=40, blank=True),
                      keep_default=False)
        ...
        # Deleting field 'LearnerDashboardTile.label'
        db.delete_column(u'admin_learnerdashboardtile', 'label')

        # Deleting field 'LearnerDashboardTile.note'
        db.delete_column(u'admin_learnerdashboardtile', 'note')

        # Deleting field 'LearnerDashboardTile.label_color'
        db.delete_column(u'admin_learnerdashboardtile', 'label_color')

        # Deleting field 'LearnerDashboardTile.note_color'
        db.delete_column(u'admin_learnerdashboardtile', 'note_color')


        # Changing field 'LearnerDashboardTile.title'
        db.alter_column(u'admin_learnerdashboardtile', 'title', self.gf('django.db.models.fields.CharField')(max_length=20))
        # Adding field 'BrandingSettings.navigation_colors'
        db.add_column(u'admin_brandingsettings', 'navigation_colors',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True),
                      keep_default=False)

        # Adding field 'BrandingSettings.text_colors'
        db.add_column(u'admin_brandingsettings', 'text_colors',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True),
                      keep_default=False)
        ...
        # Deleting field 'BrandingSettings.icon_color'
        db.delete_column(u'admin_brandingsettings', 'icon_color')

        # Deleting field 'BrandingSettings.background_color'
        db.delete_column(u'admin_brandingsettings', 'background_color')
    ...
    models = {
        ...
        u'admin.brandingsettings': {
            ...
            'background_color': ('django.db.models.fields.CharField', [], {'max_length': '20', 'blank': 'True'}),
            ...
            'navigation_color': ('django.db.models.fields.CharField', [], {'max_length': '20', 'blank': 'True'}),
            'title_color': ('django.db.models.fields.CharField', [], {'max_length': '20', 'blank': 'True'})
        },
