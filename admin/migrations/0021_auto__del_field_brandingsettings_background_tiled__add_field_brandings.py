...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'BrandingSettings.background_tiled'
        db.delete_column(u'admin_brandingsettings', 'background_tiled')
        ...
        # Adding field 'BrandingSettings.background_style'
        db.add_column(u'admin_brandingsettings', 'background_style',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'BrandingSettings.background_tiled'
        db.add_column(u'admin_brandingsettings', 'background_tiled',
        ...
        # Deleting field 'BrandingSettings.background_style'
        db.delete_column(u'admin_brandingsettings', 'background_style')
    ...
    models = {
        ...
        u'admin.brandingsettings': {
            ...
            'discover_navigation_color': ('django.db.models.fields.CharField', [], {'max_length': '20', 'blank': 'True'}),
