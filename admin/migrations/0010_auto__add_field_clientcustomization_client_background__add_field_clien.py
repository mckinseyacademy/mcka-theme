...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClientCustomization.client_background'
        db.add_column(u'admin_clientcustomization', 'client_background',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'ClientCustomization.client_background_css'
        db.add_column(u'admin_clientcustomization', 'client_background_css',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ClientCustomization.client_background'
        db.delete_column(u'admin_clientcustomization', 'client_background')

        # Deleting field 'ClientCustomization.client_background_css'
        db.delete_column(u'admin_clientcustomization', 'client_background_css')
