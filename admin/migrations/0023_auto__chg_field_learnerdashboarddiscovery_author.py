...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'admin_learnerdashboarddiscovery', 'author', self.gf('django.db.models.fields.CharField')(max_length=5000))

    def backwards(self, orm):

        # Changing field 'LearnerDashboardDiscovery.author'
        db.alter_column(u'admin_learnerdashboarddiscovery', 'author', self.gf('django.db.models.fields.CharField')(max_length=20))
    ...
    models = {
        ...
        u'admin.learnerdashboarddiscovery': {
            ...
            'author': ('django.db.models.fields.CharField', [], {'max_length': '5000', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
