...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'admin_emailtemplate', (
        ...
        db.send_create_signal(u'admin', ['EmailTemplate'])


    def backwards(self, orm):
        # Deleting model 'EmailTemplate'
        db.delete_table(u'admin_emailtemplate')
    ...
    models = {
        ...
        u'admin.learnerdashboardtile': {
            ...
            'position': ('django.db.models.fields.IntegerField', [], {'default': '100'}),
            'sub_label': ('django.db.models.fields.CharField', [], {'max_length': '40', 'blank': 'True'}),
