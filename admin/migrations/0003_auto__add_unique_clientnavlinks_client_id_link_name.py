...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ClientNavLinks', fields ['client_id', 'link_name']
        db.create_unique(u'admin_clientnavlinks', ['client_id', 'link_name'])


    def backwards(self, orm):
        # Removing unique constraint on 'ClientNavLinks', fields ['client_id', 'link_name']
        db.delete_unique(u'admin_clientnavlinks', ['client_id', 'link_name'])
