...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ClientCustomization.identity_provider'
        db.add_column(u'admin_clientcustomization', 'identity_provider',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Deleting field 'AccessKey.identity_provider'
        db.delete_column(u'admin_accesskey', 'identity_provider')


    def backwards(self, orm):
        # Deleting field 'ClientCustomization.identity_provider'
        db.delete_column(u'admin_clientcustomization', 'identity_provider')

        # Adding field 'AccessKey.identity_provider'
        db.add_column(u'admin_accesskey', 'identity_provider',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)
