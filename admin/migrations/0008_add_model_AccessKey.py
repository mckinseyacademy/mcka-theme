...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'admin_accesskey', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('code', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50)),
            ('identity_provider', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('client_id', self.gf('django.db.models.fields.IntegerField')()),
            ('course_id', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('program_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ...
            ('user_count', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True)),
        ))
        db.send_create_signal(u'admin', ['AccessKey'])


    def backwards(self, orm):
        # Deleting model 'AccessKey'
        db.delete_table(u'admin_accesskey')
