...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ClientCustomization'
        db.create_table(u'admin_clientcustomization', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('client_id', self.gf('django.db.models.fields.IntegerField')(unique=True, db_index=True)),
            ('hex_notification', self.gf('django.db.models.fields.CharField')(max_length=7)),
            ('hex_background_bar', self.gf('django.db.models.fields.CharField')(max_length=7)),
            ('hex_program_name', self.gf('django.db.models.fields.CharField')(max_length=7)),
            ('hex_navigation_icons', self.gf('django.db.models.fields.CharField')(max_length=7)),
            ('hex_course_title', self.gf('django.db.models.fields.CharField')(max_length=7)),
        ))
        db.send_create_signal(u'admin', ['ClientCustomization'])


    def backwards(self, orm):
        # Deleting model 'ClientCustomization'
        db.delete_table(u'admin_clientcustomization')
