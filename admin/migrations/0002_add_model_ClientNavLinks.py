...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ClientNavLinks'
        db.create_table(u'admin_clientnavlinks', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('client_id', self.gf('django.db.models.fields.IntegerField')(db_index=True)),
            ('link_name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('link_label', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('link_url', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'admin', ['ClientNavLinks'])


    def backwards(self, orm):
        # Deleting model 'ClientNavLinks'
        db.delete_table(u'admin_clientnavlinks')
    ...
    models = {
        ...
        u'admin.clientnavlinks': {
            'Meta': {'object_name': 'ClientNavLinks'},
