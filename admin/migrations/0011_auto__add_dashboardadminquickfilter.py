...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DashboardAdminQuickFilter'
        db.create_table(u'admin_dashboardadminquickfilter', (
        ...
        db.send_create_signal(u'admin', ['DashboardAdminQuickFilter'])


    def backwards(self, orm):
        # Deleting model 'DashboardAdminQuickFilter'
        db.delete_table(u'admin_dashboardadminquickfilter')
