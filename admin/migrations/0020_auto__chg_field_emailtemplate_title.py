...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EmailTemplate.title'
        db.alter_column(u'admin_emailtemplate', 'title', self.gf('django.db.models.fields.CharField')(max_length=64))

    def backwards(self, orm):

        # Changing field 'EmailTemplate.title'
        db.alter_column(u'admin_emailtemplate', 'title', self.gf('django.db.models.fields.CharField')(max_length=20))
