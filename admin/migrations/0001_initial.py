...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', serialize=False, auto_created=True, primary_key=True)),
                ('background_image', models.ImageField(upload_to='images/learner_dashboard/branding/backgrounds/', blank=True)),
                ('logo_image', models.ImageField(upload_to='images/learner_dashboard/branding/logos/', blank=True)),
                ('rule_color', models.CharField(max_length=20, verbose_name='#000000', blank=True)),
                ('icon_color', models.CharField(max_length=20, verbose_name='#000000', blank=True)),
                ('discover_title_color', models.CharField(default='#000000', max_length=20, blank=True)),
                ('discover_author_color', models.CharField(default='#000000', max_length=20, blank=True)),
                ('discover_rule_color', models.CharField(default='#000000', max_length=20, blank=True)),
                ('background_color', models.CharField(default='#D3D3D3', max_length=20, blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title_color', models.CharField(default='#FFFFFF', max_length=20, blank=True)),
                ('description_color', models.CharField(default='#FFFFFF', max_length=20, blank=True)),
                ('client_id', models.IntegerField(unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', models.IntegerField(default=100)),
                ('background_image', models.ImageField(upload_to='images/learner_dashboard/tile_backgrounds/', blank=True)),
                ('note', models.CharField(max_length=40, blank=True)),
                ('label_color', models.CharField(default='#000000', max_length=20, blank=True)),
                ('title_color', models.CharField(default='#3384CA', max_length=20, blank=True)),
                ('note_color', models.CharField(default='#868685', max_length=20, blank=True)),
                ('tile_background_color', models.CharField(default='#FFFFFF', max_length=20, blank=True)),
