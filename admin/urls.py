...
urlpatterns = patterns(
    ...
    url(r'^companies/(?P<company_id>[0-9]+)/courses/(?P<course_id>.+)/learner_dashboard/(?P<learner_dashboard_id>.+)/duplicates_list$', views.company_course_learner_dashboard_duplicates_list, name='company_course_learner_dashboard_duplicates_list'),
    url(r'^companies/(?P<company_id>[0-9]+)/courses/(?P<course_id>.+)/learner_dashboard/(?P<learner_dashboard_id>.+)/duplicate/(?P<learner_dashboard_duplicate_id>.+)$', views.company_course_learner_dashboard_duplicate, name='company_course_learner_dashboard_duplicate'),
