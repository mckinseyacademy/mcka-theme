...
urlpatterns = patterns(
    ...
    url(r'^api/companies/(?P<company_id>[0-9]+)/add_internal_company$', views.add_internal_company.as_view(), name='add_internal_company'),
    url(r'^api/companies/(?P<company_id>[0-9]+)/remove_internal_company$', views.remove_internal_company.as_view(), name='remove_internal_company'),
    ...
    url(r'^companies/internal_admin', views.internal_company, name='internal_company'),
