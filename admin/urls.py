...
urlpatterns = patterns(
    ...
    url(r'^client-admin/(?P<client_id>[0-9]+)/courses/(?P<course_id>.+)/participants/email_not_started$', views.client_admin_email_not_started_users, name='client_admin_email_not_started'),
    ...
    url(r'^workgroup/course/(?P<course_id>.*)/group_projects_report', views.group_projects_report, name='group_projects_report'),
