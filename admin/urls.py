...
urlpatterns += [
    ...
    url(r'^client-admin/(?P<client_id>[0-9]+)/courses/(?P<course_id>.+)/participants/(?P<user_id>[0-9]+)/unenroll$',
        views.client_admin_unenroll_participant, name='client_admin_unenroll'),
    url(r'^client-admin/(?P<client_id>[0-9]+)/courses/(?P<course_id>.+)/participants/(?P<user_id>[0-9]+)/edit-email$',
        views.client_admin_edit_email, name='client_admin_edit_email'),
    url(r'^client-admin/(?P<client_id>[0-9]+)/courses/(?P<course_id>.+)/participants/email_not_started$',
        views.client_admin_email_not_started, name='client_admin_email_not_started'),
    url(r'^client-admin/(?P<client_id>[0-9]+)/courses/(?P<course_id>.+)/download_course_report$',
        views.client_admin_download_course_report, name='download_course_report'),
    url(r'^client-admin/(?P<client_id>[0-9]+)/courses/(?P<course_id>.+)/participants$',
        views.client_admin_course_participants, name='client_admin_course_participants'),

    url(r'^client-admin/(?P<client_id>[0-9]+)/courses/(?P<course_id>.+)/branding/reset$',
        views.client_admin_branding_settings_reset, name='client_admin_branding_settings_reset'),
    url(r'^client-admin/(?P<client_id>[0-9]+)/courses/(?P<course_id>.+)/branding$',
        views.client_admin_branding_settings, name='client_admin_branding_settings'),
    url(r'^client-admin/(?P<client_id>[0-9]+)/courses/(?P<course_id>.+)/branding/create_edit$',
        views.client_admin_branding_settings_create_edit, name='client_admin_branding_settings_create_edit'),

    # Learner dashboard urls
    url(r'^courses/(?P<course_id>.+)/learner_dashboard/(?P<learner_dashboard_id>.+)/branding_reset$',
        views.course_learner_dashboard_branding_reset, name='course_learner_dashboard_branding_reset'),
    url(r'^courses/(?P<course_id>.+)/learner_dashboard/(?P<learner_dashboard_id>.+)/branding$',
        views.course_learner_dashboard_branding, name='course_learner_dashboard_branding'),

    url(r'^courses/(?P<course_id>.+)/learner_dashboard/discover/list$',
        views.course_learner_dashboard_discover_list, name='course_learner_dashboard_discover_list'),
    url(r'^courses/(?P<course_id>.+)/learner_dashboard/discover/create$',
        views.course_learner_dashboard_discover_create_edit, name='course_learner_dashboard_discover_create_edit'),
    url(r'^courses/(?P<course_id>.+)/learner_dashboard/discover/edit/(?P<discovery_id>.*)$',
        views.course_learner_dashboard_discover_create_edit, name='course_learner_dashboard_discover_create_edit'),
    url(r'^courses/(?P<course_id>.+)/learner_dashboard/discover/delete/(?P<discovery_id>.*)$',
        views.course_learner_dashboard_discover_create_edit, name='course_learner_dashboard_discover_create_edit'),
    url(r'^courses/(?P<course_id>.+)/learner_dashboard/discover/list/reorder$',
    ...
    url(r'^courses/(?P<course_id>.+)/learner_dashboard/(?P<learner_dashboard_id>.+)/tile/(?P<tile_id>.*)$',
        views.course_learner_dashboard_tile, name='course_learner_dashboard_tile'),
    url(r'^courses/(?P<course_id>.+)/learner_dashboard/(?P<learner_dashboard_id>.+)/element_reorder$',
        views.course_learner_dashboard_tile_reorder, name='course_learner_dashboard_tile_reorder'),
    url(r'^courses/(?P<course_id>.*)/learner_dashboard',
    ...
    url(r'^course_run/view/(?P<course_run_id>.+)/$',
    ...
    url(r'^course_run/create/(?P<course_run_id>.+)$',
        views.course_run_create_edit, name='course_run_create_edit'),
    url(r'^course_run/csv_download/(?P<course_run_id>.+)/$',
    ...
    url(r'^client-admin/(?P<client_id>[0-9]+)/courses/(?P<course_id>.+)/analytics/participant$',
        views.client_admin_course_analytics_participants, name='client_admin_course_analytics_participants'),
    url(r'^client-admin/(?P<client_id>[0-9]+)/courses/(?P<course_id>.+)/analytics/progress$',
        views.client_admin_course_analytics_progress, name='client_admin_course_analytics_progress'),
    url(r'^client-admin/(?P<client_id>[0-9]+)/courses/(?P<course_id>.+)/analytics$',
        views.client_admin_course_analytics, name='client_admin_course_analytics'),
    url(r'^client-admin/(?P<client_id>[0-9]+)/courses/(?P<course_id>.+)/status$',
        views.client_admin_course_status, name='client_admin_course_status'),
    url(r'^client-admin/(?P<client_id>[0-9]+)/courses/(?P<course_id>.+)/users/(?P<user_id>[0-9]+)/progress$',
        views.client_admin_user_progress, name='client_admin_user_progress'),
    url(r'^client-admin/(?P<client_id>[0-9]+)/courses/(?P<course_id>.+)$',
        views.client_admin_course, name='client_admin_course'),
    url(r'^client-admin/programs/(?P<program_id>.+)/download_program_report',
    ...
    url(r'^courses/(?P<course_id>.*)/download_course_stats/$',
    ...
    url(r'^api/clients/(?P<client_id>[0-9]+)/download_student_list',
    ...
    url(r'^clients/(?P<client_id>[0-9]+)/upload_student_list/check/(?P<task_key>.*)$',
    ...
    url(r'^clients/(?P<client_id>[0-9]+)/mass_student_enroll/check/(?P<task_key>.*)$',
    ...
    url(r'^clients/(?P<client_id>[0-9]+)/change_company_image',
        views.change_company_image, name='change_company_image'),
    url(r'^clients/(?P<client_id>[0-9]+)/upload_company_image',
    ...
    url(r'^clients/(?P<client_id>[0-9]+)/download_student_list',
    ...
    url(r'^clients/(?P<client_id>[0-9]+)/add_students_to_program',
        views.add_students_to_program, name='add_students_to_program'),
    url(r'^clients/(?P<client_id>[0-9]+)/add_students_to_course',
        views.add_students_to_course, name='add_students_to_course'),
    url(r'^clients/(?P<client_id>[0-9]+)/user/(?P<user_id>[0-9]+)/resend',
        views.client_resend_user_invite, name='client_resend_user_invite'),
    url(r'^clients/(?P<client_id>[0-9]+)/contact/add',
        views.client_detail_add_contact, name='client_detail_add_contact'),
    url(r'^clients/(?P<client_id>[0-9]+)/contact/(?P<user_id>[0-9]+)/remove',
    ...
    url(r'^clients/(?P<client_id>[0-9]+)/(?P<img_type>[a-z]+)/edit_client_mobile_image$',
    ...
    url(r'^clients/(?P<client_id>[0-9]+)/customization',
    ...
    url(r'^clients/(?P<client_id>[0-9]+)/sso/course-create-api',
        views.create_course_access_key_api.as_view(), name='create_course_access_key_api'),
    url(r'^clients/(?P<client_id>[0-9]+)/sso/course-create',
        views.create_course_access_key, name='create_course_access_key'),
    url(r'^clients/(?P<client_id>[0-9]+)/sso/(?P<access_key_id>[0-9]+)/share',
    ...
    url(r'^programs/(?P<program_id>[0-9]+)/download_program_report',
    ...
    url(r'^workgroup/dashboard/programs/(?P<program_id>.*)/courses$',
    ...
    url(r'^workgroup/dashboard/courses/(?P<course_id>.*)/projects$',
    ...
    url(r'^workgroup/dashboardV2/companies$',
    ...
    url(r'^workgroup/course/(?P<course_id>.*)/download_group_list',
        views.download_group_list, name='download_group_list'),
    url(r'^workgroup/course/(?P<course_id>.*)/download_group_projects_report',
        views.download_group_projects_report, name='download_group_projects_report'),
    url(r'^workgroup/course/(?P<course_id>.*)/group_work_status/(?P<group_id>.*)',
    ...
    url(r'^workgroup/course/(?P<course_id>.*)/detail/(?P<workgroup_id>.*)',
        views.workgroup_detail, name='workgroup_detail'),
    url(r'^workgroup/course/(?P<course_id>.*)/assignments',
    ...
    url(r'^workgroup/group/update/(?P<group_id>[0-9]+)/(?P<course_id>.*)',
    ...
    url(r'^workgroup/project/create/(?P<course_id>.*)',
        views.workgroup_project_create, name='workgroup_project_create'),
    url(r'^workgroup/project/(?P<project_id>[0-9]+)/delete',
    ...
    url(r'^api/participants/(?P<user_id>[0-9]+)/course_manage/(?P<course_id>.+)$',
        views.participant_course_manage_api.as_view(), name='participant_course_manage_api'),
    url(r'^api/participants/(?P<user_id>[0-9]+)/admin_companies',
    ...
    url(r'^api/participants/validate_participant_email/$',
        views.validate_participant_email, name='validate_participant_email'),
    url(r'^api/participants/validate_participant_username/$',
        views.validate_participant_username, name='validate_participant_username'),
    url(r'^api/participants/import_participants/check/(?P<task_key>.*)$',
        views.import_participants_check, name='import_participants_check'),
    url(r'^api/participants/import_participants/download_activation_links/$',
    ...
    url(r'^api/participants/enroll_participants_from_csv/check/(?P<task_key>.*)$',
        views.import_participants_check, name='import_participants_check'),
    ...
    url(r'^api/companies/(?P<company_id>[0-9]+)/linkedapps$',
        views.CompanyLinkedAppsApi.as_view(), name='company_linked_apps_api'),
    url(r'^api/companies/(?P<company_id>[0-9]+)/courses$',
        views.CompanyCoursesApi.as_view(), name='company_courses_api'),
    url(r'^api/companies/(?P<company_id>[0-9]+)/fields$',
    ...
    url(r'^companies/(?P<company_id>[0-9]+)/linkedapps/(?P<app_id>[0-9]+)',
        views.company_linked_app_details, name='company_linked_app_details'),
    url(r'^companies/(?P<company_id>[0-9]+)/courses/(?P<course_id>.*)',
    ...
    url(r'^certificates/template_assets$',
    ...
    url(r'^certificates/templates/(?P<template_id>\d+)/edit$',
    ...
    # Cohorting
    url(r'^api/cohorts/courses/(?P<course_id>.+)/cohorts/(?P<cohort_id>.+)/users/(?P<username>.+)$',
        views.CohortUsers.as_view(), name='cohort_user_api'),
    url(r'^api/cohorts/courses/(?P<course_id>.+)/cohorts/(?P<cohort_id>.+)/users',
        views.CohortUsers.as_view(), name='cohort_users_api'),
    url(r'^api/cohorts/courses/(?P<course_id>.+)/cohorts/(?P<cohort_id>.+)$',
        views.CohortHandler.as_view(), name='cohort_list_api'),
    url(r'^api/cohorts/courses/(?P<course_id>.+)/settings$',
