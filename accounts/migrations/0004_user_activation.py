...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'accounts_userpasswordreset', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user_id', self.gf('django.db.models.fields.IntegerField')(unique=True)),
            ('validation_key', self.gf('django.db.models.fields.CharField')(unique=True, max_length=40, db_index=True)),
            ('time_requested', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
        ))
        db.send_create_signal(u'accounts', ['UserPasswordReset'])


    def backwards(self, orm):
        # Deleting model 'UserPasswordReset'
        db.delete_table(u'accounts_userpasswordreset')
