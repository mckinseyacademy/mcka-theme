...
class ActivationForm(NoSuffixLabelForm):
    ...
    accept_terms = forms.BooleanField(required=False, label=mark_safe('I agree to the <a href="/tos.html">Terms of Service</a> and <a href="/privacy.html">Privacy Policy</a> <span class="required-field"></span>'))
