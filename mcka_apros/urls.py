...
urlpatterns = [
    ...
    url(r'^login$', accountsviews.home, name='login'),
...
urlpatterns.extend([
    url(
        r'^learnerdashboard/(?P<learner_dashboard_id>[0-9]+)$',
        courseviews.course_learner_dashboard,
        name='course_learner_dashboard'
    ),
    url(
        r'^learnerdashboard/bookmark_lesson/(?P<learner_dashboard_id>[0-9]+)/',
        courseviews.course_learner_dashboard_bookmark_lesson,
        name='course_learner_dashboard_bookmark_lesson'
    ),
    url(
        r'^learnerdashboard/bookmark_tile/(?P<learner_dashboard_id>[0-9]+)/',
    ...
    url(
        r'^learnerdashboard/(?P<learner_dashboard_id>[0-9]+)/calendar$',
