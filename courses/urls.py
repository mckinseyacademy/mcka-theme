...
urlpatterns = patterns('',
    url(r'^(?P<course_id>.*)/lessons/(?P<chapter_id>.*)/module/(?P<page_id>.*)/learner_dashboard/(?P<learner_dashboard>.*)$', views.navigate_to_lesson_module, name='navigate_to_lesson_module'),
    ...
    url(r'^(?P<course_id>.*)/progressv2/(?P<user_id>.*)$', views.course_user_progress_v2, name='course_user_progress_v2'),
    url(r'^(?P<course_id>.*)/progressv2$', views.course_progress_v2, name='course_progress_v2'),
