...
urlpatterns = patterns('',
    ...
    url(r'^(?P<course_id>.*)/learner_dashboard_discussion$', views.course_discussion_learner_dashboard, name='course_discussion_learner_dashboard'),
    ...
    url(r'^(?P<course_id>.*)/learner_dashboard_group_work$', views.user_course_group_work_learner_dashboard, name='user_course_group_work_learner_dashboard'),
