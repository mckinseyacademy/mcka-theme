...
urlpatterns = patterns('',
    ...
    url(r'^(?P<course_id>.*)/gradebook-json$', views.get_user_complete_gradebook_json, name='get_user_complete_gradebook_json'),
    ...
    url(r'^(?P<course_id>.*)/jump_to/(?P<page_id>.*)$', views.infer_page_navigation, name='infer_page_navigation'),
    ...
    url(r'^(?P<course_id>.*)/group_submission_notify/(?P<group_id>.*)$', views.notify_group_on_submission, name='notify_group_on_submission'),
