...
urlpatterns = patterns('',
    url(r'^(?P<course_id>.*)/lessons/(?P<chapter_id>.*)/module/(?P<page_id>\w+)$', views.navigate_to_page, name='navigate_to_page'),
    url(r'^(?P<course_id>.*)/lessons/(?P<chapter_id>.*)/module/(?P<page_id>\w+)/view/(?P<current_view>\w+)$', views.navigate_to_page, name='navigate_to_page'),
