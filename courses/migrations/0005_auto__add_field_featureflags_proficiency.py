...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FeatureFlags.proficiency'
        db.add_column(u'courses_featureflags', 'proficiency',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'FeatureFlags.proficiency'
        db.delete_column(u'courses_featureflags', 'proficiency')
