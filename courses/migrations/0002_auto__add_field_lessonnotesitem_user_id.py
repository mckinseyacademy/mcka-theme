...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LessonNotesItem.user_id'
        db.add_column(u'courses_lessonnotesitem', 'user_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LessonNotesItem.user_id'
        db.delete_column(u'courses_lessonnotesitem', 'user_id')
