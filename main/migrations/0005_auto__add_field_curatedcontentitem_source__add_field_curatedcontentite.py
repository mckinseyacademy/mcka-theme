...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CuratedContentItem.source'
        db.add_column('curated_content_item', 'source',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'CuratedContentItem.byline_title'
        db.add_column('curated_content_item', 'byline_title',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CuratedContentItem.source'
        db.delete_column('curated_content_item', 'source')

        # Deleting field 'CuratedContentItem.byline_title'
        db.delete_column('curated_content_item', 'byline_title')
