...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CuratedContentItem.created_at'
        db.add_column('curated_content_item', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'CuratedContentItem.display_date'
        db.add_column('curated_content_item', 'display_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CuratedContentItem.created_at'
        db.delete_column('curated_content_item', 'created_at')

        # Deleting field 'CuratedContentItem.display_date'
        db.delete_column('curated_content_item', 'display_date')
